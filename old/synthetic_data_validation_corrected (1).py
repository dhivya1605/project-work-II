...
# ─────────────────────────────────────────────────────────────────────────────
FILES = {
    "Sobol":    "Synthetic_Crop_Data_Sobol_Improved.xlsx",
    "LHS":      "Synthetic_Crop_Data_LHS_Stratified.xlsx",
    "Hybrid":   "Synthetic_Crop_Data_Hybrid_Final.xlsx",
    "Copula":   "Synthetic_Crop_Data_Copula_Final.xlsx",
    "TruncNorm":"Synthetic_Crop_Data_TruncatedNormal.xlsx",
    "Beta":     "Synthetic_Crop_Data_Beta_Final.xlsx",
}

# Numerical features to validate
NUM_FEATURES = [
    'SOIL_PH', 'TEMP', 'CROPDURATION',
...
def cat3_npk_correlation(dfs):
    ...
    Copula and Hybrid should preserve the highest correlations.
    Sobol/LHS preserve correlations only through shared crop-level structure.
    """
    print(f"\n{DIVIDER}")
    print("CATEGORY 3: NPK INTER-FEATURE CORRELATIONS")
    print(f"  Pearson ρ. Copula/Hybrid should show highest preservation.")
    print(DIVIDER)
